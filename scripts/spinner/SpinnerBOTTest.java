...
import scripts.spinner.logic.OpenDoorBack;
import scripts.utilities.Functions;
import scripts.utilities.HoverBox;
import scripts.utilities.MouseMoveJoe;

public class SpinnerBOTTest extends Script implements Starting, Painting {
	...
	@Override
	public void run() {
		TaskSet tasks = new TaskSet(new OpenDoorBack());
