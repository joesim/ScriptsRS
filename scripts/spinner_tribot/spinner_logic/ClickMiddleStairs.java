...
public class ClickMiddleStairs implements Task{
	...
	public boolean validate() {
		return (Inventory.getCount(Variables.BOWSTRING_ID)>=27 && Game.getPlane()==1);
	}
	...
	public void execute() {
		...
		} while (!cont && (Timing.currentTimeMillis()-t)<15000);

		// Antiban------------------------------------------------
		CustomFlaxAB.thingsToCheck();
		// -------------------------------------------------------

		MouseMoveJoe.hoverMouse(HoverBox.get(36, Variables.P_HOVERMM, 1), Variables.c4c12, 1, true, Variables.P_CHANCE_MOVE_WHEN_MOUSE_MM,
				true,10000);
