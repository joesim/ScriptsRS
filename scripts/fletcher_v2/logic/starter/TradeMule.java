package scripts.fletcher_v2.logic.starter;
...
import scripts.fletcher_v2.logic.Starter;
...
public class TradeMule implements Task {
	...
	public boolean validate() {
		...
		return level == 1 && !Fletcherv2.tradedTheMule && Constants.grand_exchange.contains(Player.getPosition());
	}
